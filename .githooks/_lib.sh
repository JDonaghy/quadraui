...
# post-checkout is how this was first discovered upstream — it killed
# graphify's commit/merge rebuilds for the operator without any error, only a
# graph that quietly went stale after a merge.)
#
