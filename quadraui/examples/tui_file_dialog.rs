...
//! `show_folder_open_dialog` are documented to always return `None` on TUI
//! (apps should provide an in-canvas picker instead) — this demo exercises
//! that contract. See `examples/common/file_dialog_demo.rs` and the paired
//! `gtk_file_dialog` example (#427, #935) for the GTK counterpart that
//! actually shows a native dialog.
//!
