//! Crossterm → `crate::UiEvent` translation.
//!
...
//!   [`crate::dispatch`] / [`crate::dispatch::dispatch_mouse_down`].
...
/// [`the runner loop`] uses this to feed `UiEvent`s back
